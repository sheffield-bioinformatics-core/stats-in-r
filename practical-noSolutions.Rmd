...
An intuitive way of comparing the distributions and showing the test result on the plot is using a boxplot. For this we will revert to `ggplot2`, but we are include a p-value using the `stat_compare_means` function (from `ggpubr`.

...
3.	Individuals with RCC grade II have different levels of E2F3 than those with grade III or IV 4.	The mean value of miR499 decreases significantly after treatment
...
```{r}
png("base_plot.png")
h <- hist(Biostat2$Age,freq = FALSE)
lines(density(Biostat2$Age))
names(h)
h$counts
